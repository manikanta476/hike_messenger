...
import 'package:hike_messenger/constants/color_constants.dart';
...
class _CartScreenState extends State<CartScreen> {
  ...
  */
  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
      ...
      body: Container(
        ...
        child: productGridUIDesign(context),
      ),
    );
  }


  Widget chatListUIDesign(BuildContext context){
              ...
              child: Row(
                children: [
                  Column(
                    ...
                    children: [
                      Text("${listOfStudents[index]}", style: TextStyle(fontWeight: FontWeight.bold, fontSize: 14.0),),
                      Text("description ajldf  lajkajsf lasfjalsdfjasdf alskf ", style: TextStyle(fontWeight: FontWeight.normal, fontSize: 12.0))
                    ],
                  ),
                  Spacer(),
                  Column(
                    ...
                    children: [
                      Text("today", style: TextStyle(fontWeight: FontWeight.bold, fontSize: 14.0),),
                      Text("9:02PM", style: TextStyle(fontWeight: FontWeight.normal, fontSize: 12.0))
                    ],
                  ),
                ],
              )
  ...
  Widget productListUIDesign(BuildContext context){
    return ListView.builder(
        itemCount: listOfStudents.length,
        itemBuilder: (context, index) {
          return Container(
              ...
              child: Row(
                children: [
                  Image.network(productsData[index]["image"], width: 80, height: 80,),
                  Expanded(child: Text(productsData[index]["title"], maxLines: 2,))
                ],
              )
          );
        }
  ...
  Widget productGridUIDesign(BuildContext context) {
      ...
      itemCount: productsData.length,
        ...
        itemBuilder: (context, index) {
          return Container(
            ...
            child: Image.network(productsData[index]["image"]),
          );
        }
    );
  }
